...
package org.wso2.carbon.gateway.internal.mediation.engine.sequence.builder;
...
import org.wso2.carbon.gateway.internal.mediation.engine.sequence.FlowController;
...
public class SequenceBuilder {
    ...
    public SequenceBuilder flowController(FlowController flowController) {
        ...
        EngineConfiguration.getInstance().addSequence(sequence);
        return this;
    }
